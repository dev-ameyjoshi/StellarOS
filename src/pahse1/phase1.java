...
class start
{
    ...
    {
        FileReader fr=new FileReader("C:\\This PC\\F\\oslabphase1\\input_Phase1.txt");
    ...
    public void WRITE(int operand) throws IOException
    {
        ...
        File file=new File("C:\\ThisPC\\F\\oslabphase1\\output.txt");
    ...
    {
        File file=new File("C:\\ThisPC\\F\\oslabphase1\\output1.txt");
        FileWriter fr=new FileWriter(file, true);
        BufferedWriter br1=new BufferedWriter(fr);
        br1.newLine();
        br1.newLine();
