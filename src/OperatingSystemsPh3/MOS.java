...
public class MOS {
    ...
    MOS() {
        ...
        try {
            this.fReader = new BufferedReader(new FileReader("D:\\Amey Java\\Practice_java\\src\\OperatingSystemsPh2\\Input_Phase1.txt"));
        } catch (FileNotFoundException ex) {
            Logger.getLogger(MOS.class.getName()).log(Level.SEVERE, null, ex);
        }
        try {
            this.fWriter = new BufferedWriter(new FileWriter("D:\\Amey Java\\Practice_java\\src\\OperatingSystemsPh2\\output.txt"));
